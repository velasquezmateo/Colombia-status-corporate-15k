...
Este proyecto ha sido creado con el propósito de obtener valor sobre los datos financieros de las 10.000 empresas más grandes de Colombia. Esta información es ofrecida por la Superintendencia de Sociedades, la cual reporta de forma anual los balances financieros de las 10.000 con mayor relevancia económica para un período específico comprendido entre los años 2021 a 2024. El trabajo fue realizado utilizando herramientas técnicas de análisis de datos como Python, bases de datos SQL y Power BI para visualización de insights valiosos que pueden tomar personas interesadas en inversión y gobierno.
